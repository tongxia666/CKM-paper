...
# Load the dataset
ckd_association <- fread("/n/home_fasse/txia/UKB_CKM/Data/2_vs_1_combined_training_optimization_testing.csv")
...
# Extract results for all models
  ...
  write.csv(
    annotated_results,
    paste0("/n/home_fasse/txia/UKB_CKM/Data/ckd_ckm2vs1_association_threshold_", threshold, ".csv"),
    row.names = FALSE
  )
...
new_data$HR_upper <- exp(spline_pred$fit + 1.96 * spline_pred$se.fit)
    ...
    fwrite(new_data, paste0("/n/home_fasse/txia/UKB_CKM/Data/spline_ckd_ckm2vs1_", score_var, "_model3_", label, ".csv"))
    ...
    fwrite(new_data_model4, paste0("/n/home_fasse/txia/UKB_CKM/Data/spline_ckd_ckm2vs1_", score_var, "_model4_", label, ".csv"))
  }
}
...
write.csv(
  ...
  "/n/home_fasse/txia/UKB_CKM/Data/ckd_ckm2vs1_proteomics_score_all_models_all_thresholds_stratified.csv",
  row.names = FALSE
)

write.csv(
  all_tertile_results,
  "/n/home_fasse/txia/UKB_CKM/Data/ckd_ckm2vs1_proteomics_score_tertile_models_all_thresholds_stratified.csv",
  row.names = FALSE
)
