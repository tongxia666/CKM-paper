...
# Save all results
write.csv(module_results, "/n/home_fasse/txia/UKB_CKM/Data/cvd_module_association_all_models.csv", row.names = FALSE)
write.csv(decile_results, "/n/home_fasse/txia/UKB_CKM/Data/cvd_module_decile_models.csv", row.names = FALSE)

# Completion message
print("cvd module score analysis (per-SD and decile) completed and saved.")
