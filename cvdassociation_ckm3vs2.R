...
# Load the dataset
cvd_association <- fread("/n/home_fasse/txia/UKB_CKM/Data/3_vs_2_combined_training_optimization_testing.csv")
...
important_proteins <- fread("/n/home_fasse/txia/UKB_CKM/Data/3vs2_selected_proteins_with_info_bootstrap.csv")
...
for (threshold in thresholds) {
  ...
  write.csv(
    annotated_results,
    paste0("/n/home_fasse/txia/UKB_CKM/Data/cvd_ckm3vs2_association_threshold_", threshold, ".csv"),
    row.names = FALSE
  )
  ...
  write.csv(
    bonferroni_results,
    paste0("/n/home_fasse/txia/UKB_CKM/Data/Significant_ckm3vs2_Model3_Bonferroni_Threshold_", threshold, ".csv"),
    row.names = FALSE
  )
...
write.csv(
  ...
  "/n/home_fasse/txia/UKB_CKM/Data/cvd_ckm3vs2_proteomics_score_all_models_all_thresholds_stratified.csv",
  row.names = FALSE
)
